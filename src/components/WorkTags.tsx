...
import { ALL_WORKS_TAG_NAME, koreanTagNames } from "../constants";
...
export default function WorkTags({ currentTag }: WorkTagsProps) {
    ...
    <Flex marginTop="80px" direction="column" width="100%" alignItems="center">
      ...
      >
        <Heading
          fontStyle="italic"
          fontSize={{
            base: currentTag === ALL_WORKS_TAG_NAME ? "40px" : "30px",
            md: "60px",
          }}
          fontWeight="800"
          letterSpacing={-1.5}
      ...
      >
        ...
        {Object.values(data.allMdx.group).map((group) => {
          ...
          return (
            <Link key={tag} to={`/works/tags/${tag}`}>
