...
const customComponents = {
  h1: (props: HeadingProps) => (
    <Heading as="h1" fontSize={36} mt="80px" {...props} />
  ),

  h2: (props: HeadingProps) => (
    <Heading as="h2" fontSize={32} mt="80px" mb="40px" {...props} />
  ),

  h3: (props: HeadingProps) => (
    <Heading as="h3" fontSize={24} mt="60px" mb="30px" {...props} />
  ),

  h4: (props: HeadingProps) => (
    <Heading as="h4" fontSize={20} mt="40px" mb="20px" {...props} />
  ),

  p: (props: TextProps) => (
    <Text fontSize={16} mt="16px" lineHeight="2" {...props} />
  ),
